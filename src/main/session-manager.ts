...
export class SessionManager {
  ...
  async reconnect(sessionId: string): Promise<SessionSummary> {
    ...
    if (runtime && !runtime.finalizing) {
      ...
      try {
        ...
        this.resourceMonitorService.deleteSession(sessionId)
      }
    }
  ...
  async getResourceSnapshot(sessionId: string): Promise<SessionResourceSnapshot> {
    ...
    return this.resourceMonitorService.getResourceSnapshot(runtime.client, sessionId)
  }
  ...
  dispose(): void {
    ...
    this.resourceMonitorService.clearAllBaselines()
  }
