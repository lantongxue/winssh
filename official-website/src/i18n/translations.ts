export const translations = {
  en: {
    ...
    download: {
      ...
      platforms: {
        macos: {
          desc: 'Requires macOS 11.0 or later.',
          arch: 'Universal (Intel / Apple Silicon)',
          btn: 'Download for macOS'
        },
        windows: {
          desc: 'Requires Windows 10 or later.',
          arch: 'x64 Installer',
          btn: 'Download for Windows'
        },
        linux: {
          desc: 'Tested on Ubuntu, Debian, Mint.',
          arch: '.deb / AppImage',
  ...
  zh: {
    ...
    download: {
      ...
      platforms: {
        macos: {
          desc: '需要 macOS 11.0 或更高版本。',
          arch: 'Universal (Intel / 苹果芯片)',
          btn: '下载 macOS 版'
        },
        windows: {
          desc: '需要 Windows 10 或更高版本。',
          arch: 'x64 安装包',
          btn: '下载 Windows 版'
        },
        linux: {
          desc: '已在 Ubuntu, Debian, Mint 验证。',
          arch: '.deb / AppImage',
          btn: '下载 Linux 版'
        }
      }
