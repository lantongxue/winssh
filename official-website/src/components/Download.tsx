          ...
          {platforms.map((platform, i) => (
            ...
            >
              ...
              <div className="mt-auto pt-6 border-t border-white/10">
                ...
                >
                  {loading || (downloadingId === 'win' && platform.id === 'windows') ? (
                ...
                {activeModal === 'macos' ? (
                  <>
                    ...
                    >
                      ...
                      <div className="flex-1">
                        <div className="text-white font-medium mb-1">
                          {t.download.modalMacAppleSilicon}
                        </div>
                        <div className="text-neutral-500 text-sm">
                          {t.download.modalMacAppleSiliconDesc}
                        </div>
                      </div>
                    </button>
                    <button
                    ...
                    >
                      ...
                      <div className="flex-1">
                        <div className="text-white font-medium mb-1">
                          {t.download.modalMacIntel}
                        </div>
                        <div className="text-neutral-500 text-sm">
                          {t.download.modalMacIntelDesc}
                        </div>
                      </div>
                    </button>
                  </>
                  ...
                  <>
                    ...
                    >
                      ...
                      <div className="flex-1">
                        <div className="text-white font-medium mb-1">
                          {t.download.modalLinuxDeb}
                        </div>
                        <div className="text-neutral-500 text-sm">
                          {t.download.modalLinuxDebDesc}
                        </div>
                      </div>
                    </button>
                    <button
                      onClick={() =>
                        executeDownload(getDownloadUrl('linux-appimage'), 'linux-appimage')
                      }
                      disabled={downloadingId !== null}
                      className="flex items-center gap-4 p-4 rounded-2xl bg-white/5 border border-white/10 hover:bg-white/10 hover:border-white/20 transition-all text-left group disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      ...
                      <div className="flex-1">
                        <div className="text-white font-medium mb-1">
                          {t.download.modalLinuxAppImage}
                        </div>
                        <div className="text-neutral-500 text-sm">
                          {t.download.modalLinuxAppImageDesc}
                        </div>
                      </div>
                    </button>
                  </>
