...
export function LanguageToggle() {
  ...
  return (
    ...
    >
      <span className={lang === 'en' ? 'text-white' : 'text-neutral-500 transition-colors'}>EN</span>
      <span className="text-neutral-600 font-normal">/</span>
      <span className={lang === 'zh' ? 'text-white' : 'text-neutral-500 transition-colors'}>中</span>
    </button>
  );
}
