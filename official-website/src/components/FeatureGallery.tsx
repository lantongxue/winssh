        ...
        >
          {features.map((feature, idx) => (
            ...
            >
              ...
              />
              <div className={`absolute bottom-0 inset-x-0 p-2 bg-gradient-to-t from-black/80 to-transparent text-left transition-opacity duration-300 ${activeIndex === idx ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'}`}>
